...
static const ERR_STRING_DATA SSL_str_functs[] = {
    ...
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLS_PROCESS_CKE_KEM, 0),
     "tls_process_cke_kem"},
...
static const ERR_STRING_DATA SSL_str_reasons[] = {
    ...
    {ERR_PACK(ERR_LIB_SSL, 0, SSL_R_ENCAPSULATION_FAILED),
    ...
    {ERR_PACK(ERR_LIB_SSL, 0, SSL_R_INITIALISATION_FAILED),
    ...
    {ERR_PACK(ERR_LIB_SSL, 0, SSL_R_KEM_CIPHERTEXT_LENGTH_IS_WRONG),
    "kem ciphertext length is wrong"},
    {ERR_PACK(ERR_LIB_SSL, 0, SSL_R_KEM_NOT_YET_SUPPORTED),
    "kem not yet supported"},
    ...
    {ERR_PACK(ERR_LIB_SSL, 0, SSL_R_NO_PRIVATE_KEY), "no private key"},
    ...
    {ERR_PACK(ERR_LIB_SSL, 0, SSL_R_PACKET_FAILED), "packet failed"},
    ...
    {ERR_PACK(ERR_LIB_SSL, 0, SSL_R_WRONG_VERSION), "wrong version"},
